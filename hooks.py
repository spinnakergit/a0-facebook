"""Plugin lifecycle hooks for the Facebook Pages plugin.
...
def install(**kwargs):
    ...
    # 3. Create symlink so 'from plugins.facebook.helpers...' imports work
...
def uninstall(**kwargs):
    ...
    # Remove skills
    skills_dst = a0_root / "usr" / "skills"
    for skill_name in ['facebook-engage', 'facebook-post', 'facebook-research']:
