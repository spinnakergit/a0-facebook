"""One-time setup script for the Facebook Pages plugin.
...
logger = logging.getLogger("facebook_init")
...
def main():
    python = _find_python()
    # Dependencies: aiohttp for async Graph API calls
    deps = {
